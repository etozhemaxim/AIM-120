...
Зависимость $i_\text{В}$ от $\text{М}$ представлена на рисунке \ref{i_v}.

\begin{figure}[H]
\centering
\includegraphics[width=0.7\textheight]{images/i_v.png}
\caption{ависимость $i_\text{В}$ от $\text{М}$}
\label{i_v}
\end{figure}
...
\subsection{Расчёт $c_\text{x0.нос}$ }

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textheight]{images/с_x_0_par.png}
\caption{Зависимость $c_{x0}$ от $\text{М}$}
\label{с_x_0_par}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textheight]{images/c_x.png}
\caption{Зависимость $c_x$ от $\text{М}$}
\label{с_x_0_par}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.65\textheight]{images/c_x_1.png}
\caption{Зависимость $c_x$ от $\text{М}$}
\label{с_x_0_par}
\end{figure}
...
\caption{Зависимость $m_z$ от $\alpha$}
\label{с_x_0_par}
\end{figure}
