...
{\footnotesize
    \begin{tabularx}{\textwidth}{c m{0.93\textwidth}}
        \begin{minipage}{0.07\textwidth}
            \includegraphics[width=1.9\linewidth]{images/BMSTU}
        \end{minipage}
        &
        \begin{center}
            \bfseries
...
\begin{center}
    ...
    \vspace{3cm}
    {
    {\fontsize{26}{30}\selectfont \textswab{B e r e c h n u n g s e r l ä u t e r u n g}}\\
    \vspace{3mm}
    {\fontsize{26}{30}\selectfont \textswab{zur   K u r s a r b e i t}}\\
    \vspace{7mm}
    {\large по дисциплине: {\fontsize{16}{18}\selectfont \textswab{E n t w u r f   von   R a k e t e n w a f f e n}}}\\
        \vspace{3mm}
        {\large на тему: <<Определение баллистических характеристик ЛА>>}\\
        \vspace{1.5cm}
        {\large Вариант №{228}}\\
    }
    \vspace{3cm}
    ...
    \begin{tabularx}{\textwidth}{p{7cm}p{0.1cm}p{3cm}p{0.1cm}X}
        ...
        & & & & \\
        & & & & \\
        Проверил: &  & \phantom{(подпись, дата)} & & {Л.А. Лаптева} \\ \cline{3-3}
        & & \hfil\scriptsize \raisebox{5pt}{(подпись, дата)}\hfil & & \\
    \end{tabularx}
    }
    \vfill
